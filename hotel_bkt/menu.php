      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <!-- <li class="sub">
                      <a style="cursor:pointer;background:none">Search By Name</a>
                      <ul class="sub">
                  ...
                  <li class="sub">
                      <a style="cursor:pointer;background:none">Search By Address</a>
                      <ul class="sub">
                  ...
                  <li class="sub">
                      <a style="cursor:pointer;background:none">Search By Type</a>
                      <ul class="sub">
